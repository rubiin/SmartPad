 ...
 */
public class closetab extends JTabbedPane {
    ...
    public void addTab(JTabbedPane tabs,String title, Component component) {
        tabs.addTab(title, component);
        int count = tabs.getTabCount() - 1;
        tabs.setTabComponentAt(count, new CloseButtonTab(tabs, title));
    }
    ...
    public class CloseButtonTab extends JPanel {
        ...
        public CloseButtonTab(final Component tab, String title) {
            ...
            add(jLabel);
            JButton button = new JButton(MetalIconFactory.getInternalFrameCloseIcon(10));
